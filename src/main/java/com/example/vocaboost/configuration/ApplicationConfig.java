...
package com.example.vocaboost.configuration;
...
@ComponentScan(basePackages = "com.example.vocaboost")
@EnableJpaRepositories("com.example.vocaboost.repository")
...
public class ApplicationConfig implements WebMvcConfigurer, ApplicationContextAware {
    ...
    private String uploadPath_topic;
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.example.vocaboost");
...
//    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry
                .addResourceHandler("/images/topic/**")
                .addResourceLocations("file:" + uploadPath_topic);
    }
